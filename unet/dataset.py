...
class JointTransform2D:
    """
    Performs augmentation on images and masks when called. Due to the randomness of augmentation transforms,
    it is not enough to simply apply the same Transform from torchvision on the images and masks separetely.
    Doing this will result in messing up the ground truth masks. To circumvent this problem, this class can
    ...
    Args:
        ...
        long_mask: bool, if True, returns the masks as LongTensor in label-encoded format.
    """
...
class ImageToImage2D(Dataset):
    ...
    Usage:
        1. If used without the unet.model.Model wrapper, an instance of this object should be passed to
           torch.utils.data.DataLoader. Iterating through this returns the tuple of images, masks and images
           filename.
    ...
    Args:
        ...
        joint_transform: augmentation transform, an instance of JointTransform2D. If bool(joint_transform)
            evaluates to False, torchvision.transforms.ToTensor will be used on both images and masks.
        one_hot_mask: bool, if True, returns the masks in one-hot encoded form.
    """
